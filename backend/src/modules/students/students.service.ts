...
export class StudentsService {
  ...
  /**
   * ¿La ficha consultada es la del propio usuario? El token lleva el id de
   * usuario, no el de estudiante, asi que hay que resolverlo contra la BD.
   */
  async esFichaDelUsuario(
    userId: string,
    studentId: string,
    tenantId: string,
  ): Promise<boolean> {
